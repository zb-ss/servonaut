...
class OVHService:
    ...
    async def request_consumer_key(self) -> dict:
        ...
        access_rules = [
            ...
            {'method': 'GET', 'path': '/me/bill/*'},
            # VPS lifecycle — reinstall, resize, snapshots, monitoring, firewall
            ...
            # Dedicated server — monitoring, firewall, secondary DNS
            {'method': 'GET', 'path': '/dedicated/server/*/statistics'},
            ...
            {'method': 'POST', 'path': '/cloud/project/*/snapshot'},
